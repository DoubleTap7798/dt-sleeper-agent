...
- **Power Rankings Service** (`power-rankings-service.ts`): Championship Probability Score, Median Outcome Projection, Volatility Index, UFAS-based composite scoring replacing legacy static rankings.
