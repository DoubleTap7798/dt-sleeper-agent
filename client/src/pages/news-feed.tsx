...
import { Newspaper, RefreshCw, Search, ExternalLink, AlertTriangle, TrendingUp, Zap } from "lucide-react";
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
        ...
        <Tabs value={categoryFilter} onValueChange={setCategoryFilter}>
          <TabsList>
            ...
            <TabsTrigger value="injury" data-testid="tab-injury">Injuries</TabsTrigger>
            <TabsTrigger value="trade" data-testid="tab-trade">Trades</TabsTrigger>
            <TabsTrigger value="analysis" data-testid="tab-analysis">Analysis</TabsTrigger>
            <TabsTrigger value="waiver" data-testid="tab-waiver">Waivers</TabsTrigger>
          </TabsList>
        </Tabs>
      </div>
